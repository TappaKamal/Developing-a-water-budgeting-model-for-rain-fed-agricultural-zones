...
export default function SignInPage() {
    return (
        <div style={{
            ...
            {/* Decorative orbs */}
            <div style={{ position: "fixed", top: "10%", left: "5%", width: 400, height: 400, background: "radial-gradient(circle, rgba(8,145,178,0.10) 0%, transparent 70%)", borderRadius: "50%", pointerEvents: "none" }} />
            <div style={{ position: "fixed", bottom: "10%", right: "5%", width: 300, height: 300, background: "radial-gradient(circle, rgba(6,182,212,0.08) 0%, transparent 70%)", borderRadius: "50%", pointerEvents: "none" }} />
            ...
            <div style={{ width: "100%", maxWidth: 460, position: "relative", zIndex: 1 }}>
                ...
                <div style={{ textAlign: "center", marginBottom: 28 }}>
                    ...
                    <p style={{ color: "#64748B", fontSize: 14, marginTop: 5 }}>Water Budgeting for Rain-Fed Agriculture</p>
                </div>
